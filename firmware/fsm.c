...
typedef int (*MessageSignFunc)(const uint8_t *message, size_t message_len, const uint8_t *privkey, uint8_t *signature);
...
void fsm_msgSignIdentity(SignIdentity *msg)
{
	...
	MessageSignFunc sign_func = cryptoMessageSign;
	if (sign_ssh) {
